...
extension UIButtonVC {
    ...
    @IBAction private func btnTouchUpOutside(_ sender: UIButton) {
        print("btn touched outside")
        // called when user clicks button but then moves outside and leave
    }
    
    @IBAction private func btnTouchDragEnter(_ sender: Any) {
        print("btn touch drag enter")
    }
    
    @IBAction private func btnTouchDown(_ sender: UIButton) {
