  ...
  struct storyboard {
    ...
    struct autolayoutExercise: RswiftResources.StoryboardReference, RswiftResources.InitialControllerContainer {
      ...
      func validate() throws {
        ...
        if loginViewController() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'loginViewController' could not be loaded from storyboard 'AutolayoutExercise' as 'LoginViewController'.") }
        if signupViewController() == nil { throw RswiftResources.ValidationError("[R.swift] ViewController with identifier 'signupViewController' could not be loaded from storyboard 'AutolayoutExercise' as 'SignupViewController'.") }
      }
    }
